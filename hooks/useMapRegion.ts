...
export const useMapRegion = ({data, routeState, mapRef}: {
  data: RouteResult;
  ...
  useEffect(() => {
    let centerLat = 0, centerLon = 0, deltaLat = 0.004, deltaLon = 0.002;
  ...
  const handlePressRoute = useCallback(async (index: number) => {
