...
import { removeLastLogin } from "./challengeSlice";
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(loginUser.fulfilled, (state, action) => {
      ...
      state.refreshTokenExpiresAt =
        action.payload.refresh_token_expire + "+0000";
    });
...
export const selectRefreshTokenExpiresAt = (state: any) =>
