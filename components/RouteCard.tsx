...
import {View, Text,  StyleSheet} from 'react-native'; // 或者你使用的库
import { RouteResult } from '../types/route'; // 假设你的RouteResult接口定义在这个文件里
...
const RouteCard: React.FC<CardProps> = ({ routeResult, isSimplified }) => {
